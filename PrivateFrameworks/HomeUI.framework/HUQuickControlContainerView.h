...
@property (nonatomic, retain) NSLayoutConstraint *controlHostViewTopConstraintToDisambiguationButton;
...
- (id)controlHostView;
- (id)controlHostViewTopConstraintToDisambiguationButton;
...
- (void)setControlHostViewTopConstraintToDisambiguationButton:(id)arg1;
